<template>
  <!-- 加按钮 -->
  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 409 121" style="enable-background:new 0 0 409 121;" xml:space="preserve">
    <g>
      <path  :fill="color" class="st0" d="M151.2,61h-8.1v-6.3h9.1l2.2-13.4H145V35h44.9v6.3h-6.4v13.4h8.3V61h-8.3v17.9h-7.4V61h-17.3L156,78.9h-7.4
        L151.2,61z M159.6,54.7h16.3V41.3h-14.2L159.6,54.7z"/>
      <path :fill="color" class="st0" d="M205.1,55.5h-10.9v-6.3h48.6v6.3h-11.9v15.8c0,0.5,0.2,1,0.5,1.3c0.3,0.4,0.7,0.6,1.2,0.6h10.2l-2.5,5.7h-11.5
      ...
      <path :fill="color" class="st0" d="M264.1,51.2H245v-6.3h21.6V35h7.4v9.9h19.5v6.3h-20.3l-2.7,4h6.7l16.6,23.6h-9l-15.5-21.9l-15.1,22h-9.3
        L264.1,51.2z"/>
      <path :fill="color" class="st0" d="M296.2,41h2.3l-1.2-5h7l1.2,5h1.3v-6.1h7.6V41h1.3l1.2-5h7l-1.2,5h2.3v5.6h-10.7v9.5h-7.6v-9.5H296V41H296.2z
      ...
      <path :fill="color" class="st0" d="M351.6,60.4V44.7h-4.3v-6h4.3V35h6.9v3.7h2.7v6h-2.7v7.2h4.1l-4.1,9.3v12.2c0,0.8-0.1,1.6-0.4,2.3
    ...
    <g>
      <path  :fill="color" class="st0" d="M13.9,60.1c0-9.4,7.6-17,17-17s17,7.6,17,17s-7.6,17-17,17C21.5,77,13.9,69.4,13.9,60.1z"/>
      <path  :fill="color" class="st0" d="M110.7,48.1c-1.4-1.4-3.1-2.5-4.8-3.3c-0.3-0.1-0.5-0.3-0.8-0.4c-0.2-0.1-0.4-0.1-0.6-0.2
