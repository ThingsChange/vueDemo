...
let ComponentCommunicate = r =>
  require(['@page/vuePage/componentCommunicate'], r)
let ParentToChild = r =>
  require(['@page/vuePage/componentCommunicate/parentToChild'], r)
let CSS_Animation = r => require(['@page/cssStudy/animation'], r)
        ...
        },
        {
          ...
          beforeEnter(to, from, next) {
            sessionStorage.setItem(
              'nowIndex',
              +sessionStorage.getItem('nowIndex') + 1
            )
            console.group(
              '路由守卫测试：这里是beforeEnter',
